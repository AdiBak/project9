package team3647.frc2021.inputs;
...
public class Joysticks {
    ...
    /*XboxController Object for Controller; contains all Xbox Controller
Functions*/
    ...
    public Joysticks(int controllerPin) {
        ...
        rightTrigger =
            new JoystickTrigger ( controller , XboxController . Axis .
            kRightTrigger . value , .15) ;

        rightJoyStickPress = new JoystickButton(controller , 10);
        leftJoyStickPress = new JoystickButton(controller , 9);

        leftMidButton = new JoystickButton ( controller , XboxController . Button .
        kBack . value ) ;
        rightMidButton = new JoystickButton ( controller , XboxController . Button .
        kStart . value ) ;
    ...
    public double getLeftStickX () {
        return applyDeadband(controller.getRawAxis(XboxController.Axis.kLeftX.
        value )) ;
    }
    ...
    public double getRightStickX () {
        return applyDeadband(controller.getRawAxis(XboxController.Axis.kRightX
        . value ) ) ;
    }
    ...
    /*Returns 0.0 if the given value is within the specified range around
    zero . The remaining range
